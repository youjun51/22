...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作地點的類型前五名是：工作室、替代空間、非營利組織/藝術團體、美術館、校院 </li>
    <li>大部分工作者減少碳排放量的前三方法是：減少包裝、再生材料、節約能源</li>
    <li>減少商務差旅和選擇府和永續精神的活動場地對於減少碳排放量也很重要</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#FFE46B","#FFB443","#F4D1B6","#A1AACE","#B4C7D8","#C6E3E1"])
  .unknown("#CBBEC2")
)}
